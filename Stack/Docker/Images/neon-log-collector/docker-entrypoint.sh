...
if [ ! -f /etc/neoncluster/env-host ] ; then
    echo "[FATAL] The [/etc/neoncluster/env-host] file does not exist.  This file must have been generated on the Docker host by the [neon.exe] tool and be bound to the container." >&2
    exit 1
fi

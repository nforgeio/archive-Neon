...
namespace Neon.Stack.Cryptography
{
    /// <summary>
    ...
    public class TlsCertificate
    {
        ...
        public static TlsCertificate CreateSelfSigned(string hostName, int bitCount, int validDays = 365000)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception($"Certificate Error: {result.StandardError}");
                }
        ...
        /// </summary>
        [JsonProperty(PropertyName = "valid_from", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        [DefaultValue(null)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "valid_until", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        [DefaultValue(null)]
        ...
        public void Parse()
        {
            ...
            try
            {
                ...
                if (NeonHelper.IsWindows)
                {
                    ...
                    ParseCertUtil(result.StandardOutput);
                }
                else
                {
                    ...
                    ParseOpenSsl(result.StandardOutput);
                }
            }

    ...
    public struct GoTimeSpan
    {
        ...
        public static bool TryParse(string input, out GoTimeSpan goTimeSpan)
        {
            ...
            while (true)
            {
                ...
                if (!double.TryParse(input.Substring(pStart, pEnd - pStart), NumberStyles.AllowDecimalPoint, NumberFormatInfo.InvariantInfo, out value))
                {
                    return false;
                }
        ...
        public static GoTimeSpan Parse(string input)
        {
            ...
            GoTimeSpan goTimeSpan;

            if (!TryParse(input, out goTimeSpan))
            {

...
namespace Neon.Stack.IO
{
    ...
    public class PreprocessReader : TextReader
    {
        ...
        private const RegexOptions regexIgnoreCaseOptions = RegexOptions.IgnoreCase;
#else
        ...
        private string Expand(string input)
        {
            ...
            while (true)
            {
                ...
                {
#if NETCORE
                    throw new FormatException("Environment variables are not supported by portable class libraries.");
#else

...
namespace Neon.Cluster
{
    ...
    public class LogOptions
    {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "es_image", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "es_shards", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        ...
        /// no fault tolerance.
        /// </summary>
        [JsonProperty(PropertyName = "es_replicas", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "es_memory", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "kibana_image", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "host_image", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "collector_image", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "metricbeat_image", Required = Required.Default, DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        ...
        public LogOptions Clone()
        {
            return new LogOptions()
            {
                ...
                EsMemory       = this.EsMemory,
                KibanaImage    = this.KibanaImage,
                CollectorImage = this.CollectorImage,
